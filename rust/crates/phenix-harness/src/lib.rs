...
use phenix_plugin_catalog::{
    ...
    artifact_component_manifest, artifact_factory, artifact_manifest, basic_context_component_manifest,
    ...
    basic_tools_factory, basic_tools_manifest, cli_component_manifest, cli_factory, cli_manifest,
