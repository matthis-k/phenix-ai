...
pub use agent::{
    ...
    ModelInferenceFailure, ModelInferenceInterface, ModelInferenceRequest, ModelInferenceResponse, ModelToolCall,
    ModelToolDescriptor, ModelToolResult, ModelToolTurn, SkillCommand, SkillDefinition,
